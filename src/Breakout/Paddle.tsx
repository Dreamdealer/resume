...
function Paddle({ initialX, initialY }: PaddleProps, ref: React.Ref<Phaser.Physics.Arcade.Image>) {
    ...
    return <ArcadeImage ref={ref} name="paddle" x={x} y={initialY} texture="assets" frame="paddle1" immovable />;
}
